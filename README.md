...
The BMY W25Q128 driver is written in C++ 20. It's templated to support any SPI and wire that implements expected functions. Therefore this driver can be used in your Arduino, STM32, ... based projects.
...
## Driver operation
The BMY W25Q128 driver uses 4 wires SPI mode (mode 3). When instantiated, SPI and wire must be provided in the constructor. Then to initialize writing and reading, chip select pin and SPI clock rate must be provided in init function.
